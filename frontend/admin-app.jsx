...
/* ----------------------------- TOP BAR ----------------------------- */
const NAV_ITEMS = ['equipo', 'preguntas', 'acceso', 'reportes', 'ajustes'];
const navLabel = (id) => ({ equipo: window.L('Equipo', 'Team'), preguntas: window.L('Preguntas', 'Questions'), acceso: window.L('Acceso', 'Access'), reportes: window.L('Reportes', 'Reports'), ajustes: window.L('Ajustes', 'Settings') }[id]);
