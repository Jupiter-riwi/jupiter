...
(function () {
  var DICT = {
    es: {
      ...
      'auth.passwordMin': 'Contraseña (mín. 6 caracteres)', 'auth.confirm': 'Confirma la contraseña',
      'auth.login': 'Ingresar', 'auth.connecting': 'Conectando…',
      'auth.noAccount': '¿No tienes cuenta?', 'auth.register': 'Regístrate',
      'auth.haveAccount': '¿Ya tienes cuenta?', 'auth.signin': 'Inicia sesión',
      'auth.createAccount': 'Crear cuenta', 'auth.creating': 'Creando cuenta…',
      'auth.err.badCreds': 'Email o contraseña incorrectos.',
      'auth.err.server': 'No se pudo conectar con el servidor. Verifica tu conexión.',
      'auth.err.mismatch': 'Las contraseñas no coinciden.',
      'auth.err.short': 'La contraseña debe tener al menos 6 caracteres.',
      'auth.err.weak': 'La contraseña debe contener al menos 1 mayúscula, 1 minúscula y 1 carácter especial.',
      'auth.err.exists': 'Ese email ya tiene una cuenta. Inicia sesión.',
      'auth.err.create': 'No se pudo crear la cuenta. Verifica tu conexión.',
      'auth.registrationCode': 'Código de registro',
      'auth.err.invalidCode': 'El código de registro es inválido o ya ha sido utilizado.',
      'auth.expired': 'Tu sesión expiró. Vuelve a iniciar sesión.',
      // nav
      ...
      'nav.logout': 'Salir',
      // entry tiles
      'entry.live.sales': 'Pitch en vivo', 'entry.live.interview': 'Simula tu entrevista',
      'entry.live.salesDesc': 'Presenta tu pitch a un comprador con IA en tiempo real',
      'entry.live.interviewDesc': 'Practica una entrevista laboral con un entrevistador IA',
      // live setup
      'live.beta': 'Agente en vivo · BETA',
      'live.back': '← Volver',
      'live.title.sales': 'Practica con una persona real',
      'live.title.interview': 'Practica tu entrevista',
      'live.subtitle.sales': 'El agente te escucha en tiempo real y responde en personaje. Elige el escenario.',
      'live.subtitle.interview': 'Un entrevistador IA te escucha en tiempo real y repregunta. Elige el escenario.',
      'live.section.mode': 'Tipo de práctica',
      'live.section.roleSales': '¿A quién le presentas?',
      ...
      'live.section.scenarioSales': '¿Qué vienes a presentar? (opcional)',
      ...
      'mode.sales': 'Presentación de ventas', 'mode.salesDesc': 'Presentas tu pitch a un comprador',
      ...
      'live.hint': 'El agente abrirá la conversación. Responde con naturalidad.',
      'live.ptt.hold': 'Mantén presionado para hablar', 'live.ptt.talking': 'Habla… suelta para enviar',
      'live.handsfree': 'Manos libres · habla cuando quieras, el agente detecta tus turnos',
      'live.err.mic': 'Necesito permiso de micrófono.',
      'live.err.connect': 'No se pudo conectar al agente.',
      'live.err.balance': 'Saldo insuficiente: necesitas al menos 3 AT para iniciar una sesion en vivo.',
      'live.err.agent': 'El agente tuvo un problema. Reintenta.',
      ...
      'live.results.none': 'La conversación fue muy corta para evaluar. Prueba de nuevo con un intercambio más largo.',
      'live.results.again': 'Practicar de nuevo',
      'live.results.close': 'Cerrar',
      'live.rec': 'Grabando',
      'live.results.conv': 'Conversación',
      'live.results.body': 'Lenguaje corporal y voz',
      'live.results.bodyProcessing': 'Analizando tu video (postura, gestos, voz)…',
      'live.results.bodyFailed': 'No se pudo analizar el video. La conversación sí quedó evaluada.',
      'live.results.bodySkipped': 'Sin cámara: solo se evaluó la conversación.',
      // levels
    ...
    en: {
      ...
      'auth.err.weak': 'Password must contain at least 1 uppercase letter, 1 lowercase letter, and 1 special character.',
      ...
      'auth.registrationCode': 'Registration code',
      'auth.err.invalidCode': 'The registration code is invalid or has already been used.',
      ...
      'live.err.balance': 'Insufficient balance: you need at least 3 AT to start a live session.',
      ...
      'live.rec': 'Recording',
      'live.results.conv': 'Conversation',
      'live.results.body': 'Body language & voice',
      'live.results.bodyProcessing': 'Analyzing your video (posture, gestures, voice)…',
      'live.results.bodyFailed': 'Could not analyze the video. The conversation was still evaluated.',
      'live.results.bodySkipped': 'No camera: only the conversation was evaluated.',
