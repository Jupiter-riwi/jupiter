...
(function () {
  var DICT = {
    es: {
      ...
      'live.section.contextInterview': 'Vacante (contexto compilado, opcional)',
      'live.section.contextSales': 'Producto (contexto compilado, opcional)',
      'live.ctx.none': 'Sin contexto — conversación genérica',
      'live.ctx.new': '+ Nuevo',
      'live.ctx.cancel': 'Cancelar',
      'live.ctx.titlePhInterview': 'Título de la vacante (ej: Desarrollador Backend Senior)',
      'live.ctx.titlePhSales': 'Nombre del producto (ej: Apex Vision CRM)',
      'live.ctx.textPhInterview': 'Pegá la descripción del puesto y/o el CV. La IA lo compila en un brief y el entrevistador pregunta según ESTE cargo.',
      'live.ctx.textPhSales': 'Pegá la descripción del producto, mercado y cliente objetivo. El comprador objetará con conocimiento de ESTE producto.',
      'live.ctx.compile': 'Compilar contexto con IA',
      'live.ctx.compiling': 'Compilando…',
    ...
    en: {
      ...
      'live.section.contextInterview': 'Vacancy (compiled context, optional)',
      'live.section.contextSales': 'Product (compiled context, optional)',
      'live.ctx.none': 'No context — generic conversation',
      'live.ctx.new': '+ New',
      'live.ctx.cancel': 'Cancel',
      'live.ctx.titlePhInterview': 'Vacancy title (e.g. Senior Backend Developer)',
      'live.ctx.titlePhSales': 'Product name (e.g. Apex Vision CRM)',
      'live.ctx.textPhInterview': 'Paste the job description and/or résumé. The AI compiles it into a brief and the interviewer asks for THIS role.',
      'live.ctx.textPhSales': 'Paste the product, market and target-buyer description. The buyer will object with knowledge of THIS product.',
      'live.ctx.compile': 'Compile context with AI',
      'live.ctx.compiling': 'Compiling…',
