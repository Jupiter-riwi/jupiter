...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Lee 1 mensaje de features.results")
    ...
    parser.add_argument("--ack", action="store_true", help="Confirmar (ack) el mensaje leido")
